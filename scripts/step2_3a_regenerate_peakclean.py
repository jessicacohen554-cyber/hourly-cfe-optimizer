...
v2.1 additions:
  - _INTERP_PAT regex updated to match _p1interp_ filenames (CAISO/ERCOT
    coverage gap for P1 pathway interpolation files).
...
# Matches interp/dense-augment files AND p1interp files:
...
#   step_2_1_EF_CAISO_90_p1interp_90p5_97p5.parquet  ← P1 pathway interp
