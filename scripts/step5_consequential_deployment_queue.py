...
Uses the dispatch cache (step4_build_dispatch_cache) for hourly emission accounting. Each mix's
...
def write_outputs(queue, cumulative, stranding, trajectories, projections,
    ...
    output = {
        'metadata': {
            ...
            'methodology': 'Uses 8760-hour dispatch cache from step4_build_dispatch_cache for exact fossil displacement. '
    ...
    with open(OUTPUT_JS, 'w') as f:
        f.write("// Auto-generated by step5_consequential_deployment_queue.py\n")
        f.write("// Uses dispatch cache (step4_build_dispatch_cache) for hourly emission accounting\n")
