...
Usage:
  python step6_scenario_compare.py                # All ISOs
  python step6_scenario_compare.py --iso CAISO     # Single ISO
  python step6_scenario_compare.py --iso CAISO ERCOT  # Multiple ISOs
"""
...
def write_output(trajectories, trajectories_b_by_target, queue_a, queue_b,
    ...
    with open(out_js, 'w') as f:
        f.write("// Auto-generated by step6_scenario_compare.py\n")
