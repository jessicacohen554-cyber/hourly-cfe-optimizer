...
# ============================================================================
# DISPATCH — uses dispatch_utils cache (populated by step3a_build_dispatch_cache)
# ============================================================================
...
def dispatch_from_cache(iso, mix, battery_pct, battery8_pct,
    ...
    Tries the pre-built dispatch cache (step3a_build_dispatch_cache) first. Falls back to live computation
...
def main():
    ...
    for iso in ISOS:
        ...
        # Load dispatch cache from step3a_build_dispatch_cache (v2 required for detailed fields)
