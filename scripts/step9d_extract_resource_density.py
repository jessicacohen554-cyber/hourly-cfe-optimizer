#!/usr/bin/env python3
"""Step 9D — Extract per-scenario resource density data for the abatement dashboard.
...
Output: dashboard/js/resource-density-data.js
...
def main():
    print("Step 9D: Extracting resource density data for abatement dashboard")
    ...
    # Write JS output
    js_content = (
        f"// Auto-generated by step9d_extract_resource_density.py\n"
