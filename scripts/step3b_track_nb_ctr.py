...
Usage:
  python step3b_track_nb_ctr.py              # Medium-only (fast, ~30s)
  python step3b_track_nb_ctr.py --full       # All 5,832+ combos (hours)
  python step3b_track_nb_ctr.py --iso PJM    # Single ISO
"""
