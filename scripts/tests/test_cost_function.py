"""
Unit tests for cost optimization model (step2_2a_cost_optimization.py).
...
def _import_cost_function():
    ...
    try:
        from step2_2a_cost_optimization import evaluate_cost_vectorized, _table_to_arrays
        return evaluate_cost_vectorized, _table_to_arrays
    except ImportError:
        pytest.skip("step2_2a_cost_optimization.py not importable (missing dependencies)")
