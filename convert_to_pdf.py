...
SRC = Path(__file__).parent / "dashboard" / "ref-vre-investment-thesis.html"
OUT = Path(__file__).parent / "dashboard" / "ref-vre-investment-thesis.pdf"
...
/* Callout boxes */
.key-finding, .opportunity-box, .warning-box {
    padding: 14px 18px;
    margin: 16px 0;
...
/* Chart panels — just show as bordered cards */
.chart-panel-article {
    background: #f8fafc;
    border: 1px solid #e2e8f0;
    border-radius: 6px;
