...
(function () {
    ...
    // Capture currentScript synchronously (only available during initial execution)
    ...
    const pages = [
        ...
        { key: 'deck',      label: 'IPP Deck',          href: 'ipp-transition-deck.html',      icon: '&#128218;' },
    ...
    // If body exists, inject immediately; otherwise wait for DOMContentLoaded
    if (document.body) {
        injectNav();
    } else {
