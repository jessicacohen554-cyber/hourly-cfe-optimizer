...
const UNIT_COLORS = {
    coal_steam: '#2C3E50',
    coal_steam_very_low: '#3D5A70',
    coal_steam_low: '#34495E',
    coal_steam_medium: '#2C3E50',
    coal_steam_high: '#233242',
    coal_steam_very_high: '#1A252F',
    gas_ccgt: '#2372B9',
    gas_ccgt_very_low: '#2D8CD6',
    gas_ccgt_low: '#2372B9',
    gas_ccgt_medium: '#1B5E9E',
    gas_ccgt_high: '#164E84',
    gas_ccgt_very_high: '#144A7D',
    gas_ct: '#007FA4',
    gas_ct_very_low: '#009CC4',
    gas_ct_low: '#007FA4',
    gas_ct_medium: '#006A8A',
    gas_ct_high: '#005F7D',
    gas_ct_very_high: '#005570',
    oil_ct: '#9B6B3A',
};
