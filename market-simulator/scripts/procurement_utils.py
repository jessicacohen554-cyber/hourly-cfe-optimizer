...
RPS_TARGETS = {
    ...
    # PJM: Load-weighted CES/RPS — NJ EMP (9%, 100%/2050), VA VCEA (12%, 100%/2050),
    # IL CEJA (17%, 100%/2050), MD CSWA (5%, 100%/2035), DC (2%, 100%/2032),
    # NC HB951 (7%, carbon-neutral/2050). 45% of PJM load in 100% mandate states.
    'PJM':   {2025: 0.22, 2030: 0.40, 2035: 0.55, 2040: 0.68, 2045: 0.80, 2050: 0.88},
    ...
    # MISO: IL CEJA (25%, 100%/2050), MN (10%, 100%/2040), MI (15%, 100%/2040).
    # ~50% of MISO load in states with 100% clean mandates by 2040-2050.
    'MISO':  {2025: 0.15, 2030: 0.25, 2035: 0.35, 2040: 0.48, 2045: 0.52, 2050: 0.58},
