...
- `run-step1-full-pfs.yml` → `step1-full-pfs-results`
  - Writes: `data/physics_cache_v4*.parquet`, `data/checkpoints_v4/`, `dashboard/`
...
- `run-iso-thresholds.yml` → `iso-threshold-<ISO>-<THRESHOLD>`
  ...
  - Writes: `data/checkpoints/`, `data/checkpoints_v4/`, `data/physics_cache_v4_*.parquet`, `dashboard/`
