#!/usr/bin/env python3
"""
Fetch hourly generation mix and demand data from EIA API for MISO and SPP, 2021-2025.
Saves per-ISO-year JSON files matching the format of existing data.
"""
import json
import os
import sys
...
def main():
    print("=" * 70)
    print("EIA Hourly Generation + Demand Fetcher — MISO & SPP")
    ...
    for fname in sorted(os.listdir(DATA_DIR)):
        if ("MISO" in fname or "SPP" in fname) and fname.endswith(".json"):
